    ...
    for (const art of articles) {
        const created = await prisma.qAPage.create({
            data: {
                ...
                contentText: art.contentMarkdown.replace(/[#*\-`>]/g, ''),
                type: 'FAQ',
                status: 'PUBLISHED',
